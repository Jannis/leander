...
const SeverityActions: React.FunctionComponent<Props> = ({ issue }) => {
  ...
  return (
    <div className="flex-col p-4">
      ...
      <Radio.Group
        defaultValue={issue.severity || 'unknown'}
        onChange={e =>
          setSeverity({
            issue,
...
const PriorityActions: React.FunctionComponent<Props> = ({ issue }) => {
  ...
  return (
    <div className="flex-col p-4">
      ...
      <Radio.Group
        defaultValue={issue.priority || 'unknown'}
        onChange={e =>
          setPriority({
            issue,
  ...
  return (
    <div className="flex-col p-4">
      ...
      <Select
        className="w-64"
        mode="multiple"
        defaultValue={issue.projects.map(label => label.id)}
  ...
  return (
    <div className="flex-col p-4">
      ...
      <Select
        className="w-64"
        mode="multiple"
        defaultValue={issue.assignees.map(user => user.id)}
